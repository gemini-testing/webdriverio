...
function execute() {
    ...
    if (this.desiredCapabilities && this.desiredCapabilities.w3cCompatible) {
        return this.requestHandler.create('/session/:sessionId/execute/sync', { script, args }).catch(function (err) {
            throw err;
        });
    }
